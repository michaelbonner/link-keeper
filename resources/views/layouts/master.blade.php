	...
	<div class="section">
		<div class="container">
			...
			<p class="footer-buttons">
				<a href="/subject" class="button"><i class="fa fa-home" aria-hidden="true"></i> All Subjects</a>
				<a href="/tag" class="button"><i class="fa fa-tags" aria-hidden="true"></i> All Tags</a>
				<a href="/subject/create" class="button"><i class="fa fa-plus" aria-hidden="true"></i> New Subject</a>
